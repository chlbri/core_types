...
export declare type SearchOperation<K> = K extends string | number | bigint | boolean | null | undefined ? Partial<(NotExistsProp | ExistsProp) & VSO<K> & LogicalClauses<K> & ArrayClauses<K>> | K : {
