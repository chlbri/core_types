...
function generateDataTestTableWithoutId(func, actuals, expecteds) {
    const out = actuals.map((_, index) => [
        actuals[index],
        expecteds[index],
    ]);
...
exports.generateDataTestTableWithoutId = generateDataTestTableWithoutId;
