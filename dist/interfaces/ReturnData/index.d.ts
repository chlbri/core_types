...
export declare type ReturnData<T = any> = SuccessData<T> | InformationData<T> | RedirectData<T> | ClientErrorData | ServerErrorData | PermissionErrorData | TimeOutErrorData;
