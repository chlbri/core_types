...
export declare type ErrorData = ClientErrorData | ServerErrorData | PermissionErrorData | TimeOutErrorData;
export declare type ResolveData<T = any> = InformationData<T> | SuccessData<T> | RedirectData<T>;
