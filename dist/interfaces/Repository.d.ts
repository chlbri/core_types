...
declare type PRD<T> = PD<WithId<T>>;
...
export interface IRepo<T extends Entity> {
    ...
    updateMany: (search: DataSearchOperations<T>, newValue: WithoutId<Partial<T>>, limit?: number | undefined) => PRDM<T>;
    updateManyByIds: (ids: string[], newValue: WithoutId<Partial<T>>, options?: {
