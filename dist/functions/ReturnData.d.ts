...
export declare function isPermissionError(data: any): data is PermissionErrorData;
export declare function isTimeOutError(data: any): data is TimeOutErrorData;
export declare function isError(data: any): data is ClientErrorData | ServerErrorData | PermissionErrorData | TimeOutErrorData;
